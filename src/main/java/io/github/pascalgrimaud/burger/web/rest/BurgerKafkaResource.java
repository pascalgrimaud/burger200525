...
@RestController
@RequestMapping("/api/burger-kafka")
public class BurgerKafkaResource {
    private final Logger log = LoggerFactory.getLogger(BurgerKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public BurgerKafkaResource(KafkaProperties kafkaProperties) {
